...
/**
 * Satu campaign event. Dipisah jadi komponen sendiri karena tiap campaign butuh
 * hook auto-scroll-nya masing-masing, dan hook tidak boleh dipanggil di dalam
 * `.map()`.
 */
function EventCampaignCard({ campaign }: { campaign: any }) {
  ...
  return (
    <section
      ...
      style={{
        backgroundColor: campaign.styleConfig?.backgroundColor || "#1A1A1A",
      }}
    >
