...
export function ProductSection({
  ...
  // Section yang isinya masih placeholder tidak ikut bergeser sendiri — tidak
  // ada gunanya menggeser barang bohongan.
  ...
  return (
    ...
    >
      ...
      {products.length === 0 ? (
        ...
        <div
          ref={scrollRef}
          className="flex gap-3 lg:gap-4 py-2 overflow-x-auto scroll-smooth snap-x snap-mandatory scrollbar-none"
        >
...
const MOCK_PRODUCTS = [
  {
    id: "1",
    name: "Nike Full Force Low Men's",
    brand: "NIKE",
    price: 1299000,
    salePrice: 649500,
  },
...
function MockCard({
  ...
  mock: (typeof MOCK_PRODUCTS)[number];
  index: number;
}) {
  ...
  return (
    ...
    <motion.div
      ...
      className="w-[155px] lg:w-[220px] bg-white p-2.5 rounded-xl border border-gray-100 shadow-sm"
    >
      <div
        className="relative bg-gray-50 rounded-lg overflow-hidden mb-2"
      ...
      <div className="space-y-1 px-0.5">
        ...
        <p className="font-bold text-[13px] text-[#FF6B00]">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="bg-red-100 text-red-600 text-[8px] font-bold px-1 py-0.5 rounded">
            -{saving}%
          </span>
        </div>
      </div>
