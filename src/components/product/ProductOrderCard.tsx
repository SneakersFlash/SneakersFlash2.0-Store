...
export default function OrderCard({ order }: { order: any }) {
  ...
  // Deteksi status backend untuk layout tombol
        ...
        <div className="flex gap-2 w-full">
          {isCompleted ? (
            ...
            <div className="flex gap-2 w-full">
              ...
              <button className="flex-[2] py-2.5 bg-gray-50 text-gray-400 font-bold text-[12px] rounded-lg border border-gray-200" disabled>
                Order Cancelled
              </button>
            </div>
          ) : null}
